...
BOT_URL = "https://vera-ai-bot-omj8.onrender.com"
...
LLM_API_KEY = os.environ.get("GEMINI_API_KEY", "")  # <-- DO NOT COMMIT YOUR KEY
...
class DummyProvider(LLMProvider):
    def name(self) -> str:
        return "Dummy"
    def complete(self, prompt: str, system: str = None) -> str:
        return '{"specificity": 10, "category_fit": 10, "merchant_fit": 10, "decision_quality": 10, "engagement_compulsion": 10}'
...
def main():
    ...
    if LLM_PROVIDER not in ["ollama", "dummy"] and not LLM_API_KEY:
